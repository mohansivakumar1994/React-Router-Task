export default function All(){
 return (
     <div>
         ...
         <div className="row">
             {/* Card for Fullstack Development with MORN Stack */}
             <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3 py-3">
                 <div className="card h-100 mb-3">
                     <img src="./images/MORN_Image.jpg" className="card-img-top" alt="" />
                     <div className="card-body">
                         <h5 className="card-title">Fullstack Development: MORN Stack</h5>
             ...
             <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3 py-3">
                 <div className="card h-100 mb-3">
                     ...
                     <div className="card-body">
                         ...
                         <p className="card-text">Successfully perform all steps in a complex Data Science project. Create Basic Tableau visualization's. Perform Data Mining in Tableau.</p>
                         <a href="#" className="know-more-link">Know More</a>
                     </div>
                 </div>
             </div>
